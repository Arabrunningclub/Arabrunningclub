...
<div className="pointer-events-none absolute inset-0">
  ...
  <div className="absolute inset-0 [background:radial-gradient(70%_55%_at_50%_35%,transparent_0%,rgba(0,0,0,0.08)_55%,rgba(0,0,0,0.18)_100%)] dark:[background:radial-gradient(70%_55%_at_50%_35%,transparent_0%,rgba(0,0,0,0.35)_55%,rgba(0,0,0,0.75)_100%)]" />
      ...
      <section className="relative pb-20">
        <div className="container mx-auto px-4">
          <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr),minmax(0,520px),minmax(0,1fr)] items-stretch">
            {/* Left grid */}
            ...
            <div className="flex flex-col gap-4 h-full justify-between">
              ...
              >
                ...
                <h2 className="text-4xl font-bold mb-3">Make a Donation</h2>
                ...
                <label className="block text-2xl mb-2 font-medium opacity-90">Custom amount</label>
              ...
              {/* Mobile/small screen: show photo gallery below donation panel */}
              <div className="block lg:hidden mt-8">
                <PhotoGrid photos={DONATION_PHOTOS} />
              </div>
            </div>
