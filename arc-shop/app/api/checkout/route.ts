...
import { getSupabaseConfig, supabaseServiceFetch } from "@/lib/supabase-admin";
...
export async function POST(request: Request) {
  try {
    ...
    stripeBody.set(
      "success_url",
      `${origin}/checkout/success?session_id={CHECKOUT_SESSION_ID}&order_id=${reserved.order_id}`,
    );
    stripeBody.set("cancel_url", `${origin}/cart?checkout=cancelled`);
