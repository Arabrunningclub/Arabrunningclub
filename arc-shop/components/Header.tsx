...
const links = [
  ["New drop", "/shop"],
  ["Run", "/shop?collection=run"],
  ["Off-duty", "/shop?collection=off-duty"],
  ["Objects", "/shop?collection=objects"],
] as const;
    ...
    <>
      ...
      <header className="site-header">
        ...
        <div className="header-actions">
          <Link className="text-action desktop-only" href="/shop">
            Search
          </Link>
          <Link className="text-action desktop-only" href="/admin">
            Account
          </Link>
          <button
